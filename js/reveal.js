...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		dom.pauseOverlay = createSingletonNode( dom.wrapper, 'div', 'pause-overlay', config.controls ? '<button class="resume-button"><a href="#/1">check out my works</a></button>' : null );
